...
jsPsych.plugins["html-keyboard-responseMAS-sortingSets"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('html-keyboard-responseMAS-sortingSets', 'audioTone', 'audio');


  plugin.info = {
    name: 'html-keyboard-responseMAS-sortingSets',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    //Left set
    html += '<div class = "parent" style =  "width: 600px; height:800px;  left: -350px; top: 0px; justify-content: left; ">' //"width: 500px; left: -350px; top: 0px; justify-content: left; ">'
    ...
    html += '<div >' 
        ...
        //Square 1
        html += '<div class="square" style = "position: relative; left: 400px; top: -650px; width: 350px; height: 300px;" >'// left: 300px; top: -375px;" >'
