...
jsPsych.plugins['survey-multi-choice-colorCircle'] = (function() {
  var plugin = {};

  plugin.info = {
    name: 'survey-multi-choice-colorCircle',
    description: '',
    parameters: {
      questions: {
  ...
  plugin.trial = function(display_element, trial) {
    var plugin_id_name = "jspsych-survey-multi-choice-colorCircle";
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      html += '<div class="circleBig" style = "background-color:rgb('+trial.promptedColorR[trial.promptedColor]+','+trial.promptedColorG[trial.promptedColor]+','+trial.promptedColorB[trial.promptedColor]+'); position: relative; left: 220px; top: -10px; ";></div>'
      html += '<br>'
