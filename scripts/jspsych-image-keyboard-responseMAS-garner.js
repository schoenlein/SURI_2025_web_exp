...
jsPsych.plugins["image-keyboard-responseMAS-garner"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('image-keyboard-responseMAS-garner', 'stimulus', 'image');

  plugin.info = {
    name: 'image-keyboard-responseMAS-garner',
    description: '',
    parameters: {
      stimulus: {
    ...
    var html = "";
         ...
         if (trial.prompt !== null && trial.prompt_location == "above") {
          if (trial.trial_type == "Present"){
           html += '<span style="font-size: 30px; display:inline-block; width: 450px;">'+trial.prompt+'</span>'
          }
