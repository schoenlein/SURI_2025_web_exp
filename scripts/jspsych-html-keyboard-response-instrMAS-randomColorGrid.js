...
jsPsych.plugins["html-keyboard-response-instrMAS-randomColorGrid"] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'html-keyboard-response-instrMAS-randomColorGrid',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    //For j rows
     for (j = 0; j < 3; j++){
      ...
      //  html += trial.prompt2
        html += '<span style="position: relative; top: 100px;">'+trial.prompt2+'</span>';
      }
