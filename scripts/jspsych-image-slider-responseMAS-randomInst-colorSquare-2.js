...
jsPsych.plugins['image-slider-responseMAS-randomInst-colorSquare-2'] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('image-slider-responseMAS-randomInst-colorSquare-2', 'stimulus');

  plugin.info = {
    name: 'image-slider-responseMAS-randomInst-colorSquare-2',
    description: '',
    parameters: {
      stimulus: {
  ...
  if (trial.prompt1 !== null){
    ...
    html += '<div class="jspsych-image-slider-response-container" style="position:relative; top: 200px;  margin: 0 auto 3em auto; '; // add color to this object? 
    ...
    if (trial.prompt2 !== null){
      html += '<span style="text-align: center; position:relative; top: 150px;  font-size: 100%;">'+trial.prompt2+'</span>'
  }
