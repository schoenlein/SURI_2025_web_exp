...
jsPsych.plugins["image-keyboard-responseMAS-newColorCat"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('image-keyboard-responseMAS-newColorCat', 'stimulus', 'image');

  plugin.info = {
    name: 'image-keyboard-responseMAS-newColorCat',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var html = "";
         ...
         // add prompt 
         if (trial.labelTop !== null && trial.labelTop_location == "above") {
            if (trial.trial_type == "Present"){
            html += '<span style="font-size: 30px; display:inline-block; width: 450px;">'+trial.labelTop+'</span>'
            }
    ...
    if (trial.trial_type == "Present" || trial.trial_type == "TextFeed"){
      html += '<img src="'+trial.stimulus+'" id="jspsych-image-keyboard-response-stimulus" style="';
        ...
        if (trial.response_sideSelected == 0){
          html += '<img src="'+trial.stimulus+'" id="jspsych-image-keyboard-response-stimulus" style ="position: relative; top: -70px; ';
        }
    ...
    if (trial.labelBottom !== null && trial.labelBottom_location == "below") {
      html += '<span style="font-size: 30px; display:inline-block; width: 450px;">'+trial.labelBottom+'</span>'
      //html += '<span style="font-size: 120%;">'+trial.labelBottom+'</span>'
    }
