...
jsPsych.plugins['image-slider-responseMAS-randomInst-colorSquare'] = (function() {
  ...
  jsPsych.pluginAPI.registerPreload('image-slider-responseMAS-randomInst-colorSquare', 'stimulus');
  ...
  if (trial.prompt1 !== null){
    ...
    html += '<div class="jspsych-image-slider-response-container" style="position:relative; top: 70px;  margin: 0 auto 3em auto; '; // add color to this object? 
    ...
    if (trial.prompt2 !== null){
      html += '<span style="text-align: center; position:relative; top: 100px;  font-size: 100%;">'+trial.prompt2+'</span>'
  }
