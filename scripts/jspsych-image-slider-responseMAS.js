...
jsPsych.plugins['image-slider-responseMAS'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.prompt !== null){
       html += '<span style="text-align: center; font-size: 125%;">'+trial.prompt+'</span>'
   }
   ...
   html += '<br></br>';
    ...
    html += '<div class="jspsych-image-slider-response-container" style="position:relative; left: 100px; top: -50px;';//  margin: 4 auto 3em auto; '; 
    ...
    // add submit button 
    html += '<button id="jspsych-image-slider-response-next" style=position:relative class="jspsych-btn" '+ (trial.require_movement ? "disabled" : "") + '>'+trial.button_label+'</button>';
