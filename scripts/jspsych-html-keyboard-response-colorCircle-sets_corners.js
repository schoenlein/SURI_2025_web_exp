...
jsPsych.plugins["html-keyboard-response-colorCircle-sets_corners"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('html-keyboard-response-colorCircle-sets_corners', 'audioTone', 'audio');
...
/* ------- square + circles --------- */
    ...
    if(trial.feedbackTrial  < 2 ){
      ...
      //present square
      html += '<div class="square" style = "position: relative; left: 20px; top: -40px; width: 350px; height: 300px;" >'  
