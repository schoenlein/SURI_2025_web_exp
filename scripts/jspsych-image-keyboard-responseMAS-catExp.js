...
jsPsych.plugins["image-keyboard-responseMAS-catExp"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('image-keyboard-responseMAS-catExp', 'stimulus', 'image');

  plugin.info = {
    name: 'image-keyboard-responseMAS-catExp',
    description: '',
    parameters: {
      stimulus: {
      ...
      // Display labels above figure
       ...
       if (trial.prompt !== null && trial.prompt_location == "above") {
         if (trial.feedbackTrial == 0){
          html += '<span style="font-size: 120%; color: rgb('+trial.rgbBackground+'); ">'+trial.prompt+'</span>'
         }
    ...
    if (trial.feedbackTrial == 0|| trial.feedbackTrial == 1){
      html += '<img src="'+trial.stimulus+'" id="jspsych-image-keyboard-response-stimulus" style="';
        ...
        if (trial.species == "FILK" ){
          html += '<img src="'+trial.stimulus+'" id="jspsych-image-keyboard-response-stimulus" style ="position: relative; left: -160px; top: -60px;';
        }
        else if (trial.species == "SLUB"){
          html += '<img src="'+trial.stimulus+'" id="jspsych-image-keyboard-response-stimulus" style ="position: relative; right: -160px; top: -60px;';
        }
    }
