 ...
 //html += '<div id="jspsych-image-slider-response-stimulus">';
   ...
   // html += '<span style="text-align: center; font-size: 125%;">'+trial.prompt2+'</span>' // Label 
    ...
    //     shift = shift+ + 10; //width: 3%; 
        html += '<img src="'+trial.stimulus+'"; style ="width: 250px; position: relative;" '; 
        html += '"></img>'; 
    //   }
    //   html += '<div style="line-height:10px;">';
    //   html += '<br>'
    ...
    html += '<div class="jspsych-image-slider-response-container" style="position:relative; top:-50px; margin: 0 auto 3em auto; '; // add color to this object? 
