...
jsPsych.plugins["html-keyboard-responseMAS-sorting_borders18"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('html-keyboard-responseMAS-sorting_borders18', 'audioTone', 'audio');


  plugin.info = {
    name: 'html-keyboard-responseMAS-sorting_borders18',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
   ...
   // html += '<div >' 
        ...
        //Square 1
        html += '<div class="square" style = "position: relative; left: 400px; top: -600px; width: 400px; height: 275px;" >'// left: 300px; top: -375px;" >'
        ...
        //New Square 2
        html += '<div class="square" style = "position: relative; left: -1.7px; top: -700px; width: 400px; height: 275px;" >'
