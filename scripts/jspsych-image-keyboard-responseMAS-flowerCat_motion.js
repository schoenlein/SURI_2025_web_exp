...
jsPsych.plugins["image-keyboard-responseMAS-flowerCat_motion"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('image-keyboard-responseMAS-flowerCat_motion', 'stimulus', 'image');
  ...
  plugin.trial = function(display_element, trial) {
   ...
   // else if (trial.feedbackTrial == 2){
        // Move image underneath the correct species 
         ...
         html += '<img src="'+trial.stimulusCenter+'" id="jspsych-image-keyboard-response-stimulus" style ="position: relative; top: -170px; height:'+trial.stimulus_height+'px;"';
       // }
