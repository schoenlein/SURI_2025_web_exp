...
jsPsych.plugins["html-keyboard-response-colorCircle-sets"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('html-keyboard-response-colorCircle-sets', 'audioTone', 'audio');


  plugin.info = {
    name: 'html-keyboard-response-colorCircle-sets',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if(trial.feedbackTrial == 0){
      ...
      html += '<div class="square" style = "position: relative; left: 20px; top: -40px; width: 350px; height: 300px;" >'// left: 300px; top: -375px;" >'
