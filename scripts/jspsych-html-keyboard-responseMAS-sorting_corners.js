...
jsPsych.plugins["html-keyboard-responseMAS-sorting_corners"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('html-keyboard-responseMAS-sorting_corners', 'audioTone', 'audio');
  ...
  plugin.trial = function(display_element, trial) {
   ...
   // html += '<div >' 
        ...
        for(var i = 0; i < 8;i++){//trial.colorCounter.length;) {
          var j = i
          var topRowAdjust = 0
          if (i >= 4)  
            {j = i -4
        ...
        //New Square 2
        html += '<div class="square" style = "position: relative; left: -1.7px; top: -150px; width: 350px; height: 300px;" >'
