...
jsPsych.plugins["image-keyboard-responseMAS"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.trial_type == "Present" || trial.trial_type == "TextFeed"){
        html += '<div style="width:100px;height:100px; margin: 0 auto 3em auto; background-color:rgb('+trial.stimulus+');"'
        ...
        if (trial.response_sideSelected == 0){
          html += '<img src="'+trial.stimulus+'" id="jspsych-image-keyboard-response-stimulus" style ="position: relative; left: -230px; top: -50px; ';
        }
        else if (trial.response_sideSelected == 1){
          html += '<img src="'+trial.stimulus+'" id="jspsych-image-keyboard-response-stimulus" style ="position: relative; right: -230px; top: -50px;';
        }
    }
