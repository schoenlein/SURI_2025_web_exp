var jsPsychImageKeyboardResponseMAS = (function (jspsych) {
  'use strict';

  var version = "2.1.0";

  const info = {
    name: "image-keyboard-response_MAS",
    version,
    parameters: {
    ...
    trial(display_element, trial) {
      ...
      //not on canvas
       ...
       if (trial.prompt !== null) {
        ...
        img.style.top = trial.stimulus_top + "px" ;
        img.style.left = trial.stimulus_left + "px";
      }
